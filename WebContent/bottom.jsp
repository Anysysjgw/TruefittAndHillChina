...
<section class="l__full t__gold image-id-1" data-ui="Made In Britain" style="background-image: url(./pic/made.jpg)">
    ...
    <a href="/pages/made-in-britain" class="btn--hollowGold">阅读更多</a>
</section>
...
<section data-ui="Call Out Boxes">
    <ul class="l__list--two">
        <li class="l__gold l__block l__dis--table l__padding--none t__white callout--razor">
            <div class="l__middle">
                <h4 class="l__max-width">剃须&middot;礼遇</h4>
                <a href="/collections/gifts" class="btn--hollowWhiteGold btn--compact">查看礼品装<svg width="26" height="45" viewBox="0 0 26 45" xmlns="http://www.w3.org/2000/svg" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns"><path d="M3.5.1l22.5 22.5-22.5 22.4-3.5-3.5 18.9-18.9-18.9-18.9 3.5-3.6z" sketch:type="MSShapeGroup" /></svg></a>
            </div>
        </li>
	...
	<ul class="footerNav t__alignLeft l__cf l__full">
		...
		<li class="footerNav__col">
			<ul class="is--collapsed">
				<h6 class="js__toggleCollapsed">产品列表</h6>
				<li><a href="/collections/shaving">剃须</a></li>
				<li><a href="/collections/face-body">面部 & 身体</a></li>
				<li><a href="/collections/hair-care">头发护理</a></li>
				<li><a href="/collections/travel-accessories">配件 & 旅行装</a></li>
				<li><a href="/collections/fragrances">香氛系列</a></li>
				<li><a href="/collections/gifts">礼品装</a></li>
				<li><a href="/collections/beard-moustache-range">两鬓护理</a></li>
			</ul>
		</li>
		<li class="footerNav__col">
			<ul class="is--collapsed">
				<h6 class=js__toggleCollapsed>快速导航</h6>
				<li><a href="/pages/about-us">关于我们</a></li>
				<li><a href="/pages/history">品牌故事</a></li>
				<li><a href="/pages/made-in-britain">英国制造</a></li>
				<li><a href="/collections/barber-services">店铺介绍</a></li>
			</ul>
		</li>
		<li class="footerNav__col">
			<ul class="is--collapsed">
				<h6 class=js__toggleCollapsed>更多信息</h6>
...
<!-- 	<div class="countrySelect l__footer__align">
		...
		<small class="is--medium">China</small>
	</div> -->
